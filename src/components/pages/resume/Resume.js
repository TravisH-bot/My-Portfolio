  ...
  return (
    <section className="main-container content">
      ...
      <section className="flexbox-item body-content">
        ...
        <section className="front-end-mentor">
          <div className="fem-title">
            <h2 className="fem-text text-4xl">Check out my work on </h2>
          </div>
          <div className="fem-svg">
            ...
            >
              <svg
                className="fem bg-blue-100 bg-opacity-50 hover:bg-opacity-100"
                width="175"
                height="25"
                viewBox=""
              ...
              >
                <g fill-rule="nonzero" fill="none">
                  ...
                  <g fill="#F9C7C5">
                    ...
                    <path d="M49.316 24.798a.746.746 0 0 1-.53-.22l-3.273-3.274-3.272 3.273a.75.75 0 1 1-1.061-1.061l3.803-3.804a.773.773 0 0 1 1.061 0l3.804 3.805a.75.75 0 0 1-.532 1.281z" />
                    <path d="M56.924 24.798a.746.746 0 0 1-.531-.22l-3.272-3.274-3.273 3.273a.75.75 0 1 1-1.061-1.061l3.804-3.804a.75.75 0 0 1 1.06 0l3.803 3.805a.75.75 0 0 1-.53 1.281z" />
                    <path d="M64.529 24.798a.744.744 0 0 1-.529-.22l-3.273-3.274-3.273 3.273a.75.75 0 1 1-1.061-1.061l3.803-3.804a.773.773 0 0 1 1.061 0l3.805 3.805a.75.75 0 0 1-.533 1.281z" />
                    <path d="M72.137 24.798a.746.746 0 0 1-.53-.22l-3.274-3.274-3.271 3.273a.75.75 0 1 1-1.061-1.061l3.803-3.804a.773.773 0 0 1 1.061 0l3.804 3.805a.75.75 0 0 1-.532 1.281z" />
                    <g>
                      <path d="M79.743 24.798a.744.744 0 0 1-.53-.22l-3.273-3.274-3.272 3.273a.75.75 0 1 1-1.061-1.061l3.803-3.804a.773.773 0 0 1 1.061 0l3.804 3.805a.75.75 0 0 1-.532 1.281z" />
                      <path d="M87.35 24.798a.746.746 0 0 1-.53-.22l-3.273-3.274-3.272 3.273a.75.75 0 1 1-1.061-1.061l3.803-3.804a.773.773 0 0 1 1.061 0l3.804 3.805a.75.75 0 0 1-.532 1.281z" />
                      <path d="M94.957 24.798a.746.746 0 0 1-.531-.22l-3.272-3.274-3.273 3.273a.75.75 0 1 1-1.061-1.061l3.804-3.804a.75.75 0 0 1 1.06 0l3.803 3.805a.75.75 0 0 1-.53 1.281z" />
                      <path d="M102.562 24.798a.744.744 0 0 1-.529-.22l-3.273-3.274-3.273 3.273a.75.75 0 1 1-1.061-1.061l3.804-3.804a.749.749 0 0 1 1.06 0l3.804 3.805a.75.75 0 0 1-.532 1.281z" />
                      <path d="M110.17 24.798a.746.746 0 0 1-.53-.22l-3.273-3.274-3.272 3.273a.75.75 0 1 1-1.061-1.061l3.803-3.804a.75.75 0 0 1 1.06 0l3.804 3.805a.75.75 0 0 1-.531 1.281z" />
                    </g>
                  </g>
                </g>
              </svg>
